...
void setupTreeView(GtkWidget *treeview)
{
   ...
   if (visible) {
      ...
      name_column = column = gtk_tree_view_column_new_with_attributes(
         _("Package"), renderer, "markup", NAME_COLUMN,
         //"text", NAME_COLUMN,
         "background-rgba", COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
      int width = std::max(_config->FindI(columnSizeName, 200), 20);
      gtk_tree_view_column_set_fixed_width(column, width);
      g_signal_connect(G_OBJECT(column), "notify::width",
                       G_CALLBACK(onColWidthChange), (gpointer)columnSizeName);
   ...
   if (visible) {
      ...
      gtk_cell_renderer_text_set_fixed_height_from_font(
         GTK_CELL_RENDERER_TEXT(renderer), 1);
      column = gtk_tree_view_column_new_with_attributes(
         _("Section"), renderer, "text", SECTION_COLUMN, "background-rgba",
         COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
   ...
   if (visible) {
      ...
      gtk_cell_renderer_text_set_fixed_height_from_font(
         GTK_CELL_RENDERER_TEXT(renderer), 1);
      column = gtk_tree_view_column_new_with_attributes(
         _("Component"), renderer, "text", COMPONENT_COLUMN, "background-rgba",
         COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
      int width = std::max(_config->FindI(columnSizeName, 130), 20);
   ...
   if (visible) {
      ...
      gtk_cell_renderer_text_set_fixed_height_from_font(
         GTK_CELL_RENDERER_TEXT(renderer), 1);
      column = gtk_tree_view_column_new_with_attributes(
         _("Installed Version"), renderer, "text", INSTALLED_VERSION_COLUMN,
         "background-rgba", COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
      int width = std::max(_config->FindI(columnSizeName, 130), 20);
      gtk_tree_view_column_set_fixed_width(column, width);
   ...
   if (visible) {
      ...
      gtk_cell_renderer_text_set_fixed_height_from_font(
         GTK_CELL_RENDERER_TEXT(renderer), 1);
      column = gtk_tree_view_column_new_with_attributes(
         _("Latest Version"), renderer, "text", AVAILABLE_VERSION_COLUMN,
         "background-rgba", COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
      int width = std::max(_config->FindI(columnSizeName, 130), 20);
      gtk_tree_view_column_set_fixed_width(column, width);
   ...
   if (visible) {
      ...
      column = gtk_tree_view_column_new_with_attributes(
         _("Size"), renderer, "text", PKG_SIZE_COLUMN, "background-rgba",
         COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
   ...
   if (visible) {
      ...
      g_object_set(G_OBJECT(renderer), "xalign", 1.0, "xpad", 10, NULL);
      column = gtk_tree_view_column_new_with_attributes(
         _("Download"), renderer, "text", PKG_DOWNLOAD_SIZE_COLUMN,
         "background-rgba", COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
      int width = std::max(_config->FindI(columnSizeName, 80), 20);
      gtk_tree_view_column_set_fixed_width(column, width);
   ...
   if (visible) {
      ...
      gtk_cell_renderer_text_set_fixed_height_from_font(
         GTK_CELL_RENDERER_TEXT(renderer), 1);
      column = gtk_tree_view_column_new_with_attributes(
         _("Description"), renderer, "text", DESCR_COLUMN, "background-rgba",
         COLOR_COLUMN, NULL);
      gtk_tree_view_column_set_sizing(column, GTK_TREE_VIEW_COLUMN_FIXED);
   ...
   g_object_set(G_OBJECT(treeview), "fixed_height_mode", TRUE, NULL);
