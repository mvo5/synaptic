...
void setupTreeView(GtkWidget *treeview)
{
   ...
   if (visible) {
      ...
      name_column = column =
         gtk_tree_view_column_new_with_attributes(_("Package"),
                                                  renderer,
                                                  "markup",
                                                  NAME_COLUMN,
                                                  //"text", NAME_COLUMN,
      ...
      g_signal_connect(G_OBJECT(column),
                       "notify::width",
                       G_CALLBACK(onColWidthChange),
                       (gpointer)columnSizeName);
   ...
   if (visible) {
      ...
      gtk_cell_renderer_text_set_fixed_height_from_font(
         GTK_CELL_RENDERER_TEXT(renderer), 1);
      column = gtk_tree_view_column_new_with_attributes(_("Component"),
                                                        renderer,
                                                        "text",
                                                        COMPONENT_COLUMN,
                                                        "background-rgba",
   ...
   if (visible) {
      ...
      g_object_set(G_OBJECT(renderer), "xalign", 1.0, "xpad", 10, NULL);
      column =
         gtk_tree_view_column_new_with_attributes(_("Download"),
                                                  renderer,
                                                  "text",
