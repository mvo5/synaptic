...
#   define GTK_TAG_TREE(obj)                                                   \
      (G_TYPE_CHECK_INSTANCE_CAST((obj), GTK_TYPE_TAG_TREE, GtkTagTree))
#   define GTK_TAG_TREE_CLASS(klass)                                           \
      (G_TYPE_CHECK_CLASS_CAST((klass), GTK_TYPE_TAG_TREE, GtkTagTreeClass))
#   define GTK_IS_TAG_TREE(obj)                                                \
      (G_TYPE_CHECK_INSTANCE_TYPE((obj), GTK_TYPE_TAG_TREE))
#   define GTK_IS_TAG_TREE_CLASS(klass)                                        \
      (G_TYPE_CHECK_CLASS_TYPE((klass), GTK_TYPE_TAG_TREE))
#   define GTK_TAG_TREE_GET_CLASS(obj)                                         \
      (G_TYPE_INSTANCE_GET_CLASS((obj), GTK_TYPE_TAG_TREE, GtkTagTreeClass))
