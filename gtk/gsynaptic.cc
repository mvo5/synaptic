...
static GOptionEntry option_entries[] = {
   {"repositories", 'r', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Open in the repository screen"), nullptr},
   {"filter-file", 'f', G_OPTION_FLAG_NONE, G_OPTION_ARG_FILENAME, nullptr,
    N_("Give an alternative filter file"), N_("<filter-file>")},
   {"title", 't', G_OPTION_FLAG_NONE, G_OPTION_ARG_STRING, nullptr,
    N_("Give an alternative main window title (e.g. hostname with `uname -n`)"),
    N_("title")},
   {"initial-filter", 'i', G_OPTION_FLAG_NONE, G_OPTION_ARG_STRING, nullptr,
    N_("Start with the initial filter with given name"), N_("<filter-name>")},
   {"option", 'o', G_OPTION_FLAG_NONE, G_OPTION_ARG_STRING_ARRAY, nullptr,
    N_("Set an arbitrary configuration option, eg -o dir::cache=/tmp"),
    N_("<option>")},
   {"upgrade-mode", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Call Upgrade and display changes"), nullptr},
   {"dist-upgrade-mode", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Call DistUpgrade and display changes"), nullptr},
   {"update-at-startup", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Call \"Reload\" on startup"), nullptr},
   {"non-interactive", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Never prompt for user input"), nullptr},
   {"task-window", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Open with task window"), nullptr},
   {"add-cdrom", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_STRING, nullptr,
    N_("Add a cdrom at startup"), N_("<path-for-cdrom>")},
   {"ask-cdrom", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Ask for adding a cdrom and exit"), nullptr},
   {"test-me-harder", '\0', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, nullptr,
    N_("Run test in a loop"), nullptr},
   {"set-selections", '\0', G_OPTION_FLAG_HIDDEN, G_OPTION_ARG_NONE, nullptr,
    nullptr, nullptr},
   {"set-selections-file", '\0', G_OPTION_FLAG_HIDDEN, G_OPTION_ARG_STRING,
    nullptr, nullptr, nullptr},
   {"parent-window-id", '\0', G_OPTION_FLAG_HIDDEN, G_OPTION_ARG_STRING,
    nullptr, nullptr, nullptr},
   {"progress-str", '\0', G_OPTION_FLAG_HIDDEN, G_OPTION_ARG_STRING, nullptr,
    nullptr, nullptr},
   {"finish-str", '\0', G_OPTION_FLAG_HIDDEN, G_OPTION_ARG_STRING, nullptr,
    nullptr, nullptr},
   {"hide-main-window", '\0', G_OPTION_FLAG_HIDDEN, G_OPTION_ARG_NONE, nullptr,
    nullptr, nullptr},
   {0}};
      ...
      if ((lastUpdate + minimal * 3600) < time(NULL)) {
         if (update == UPDATE_AUTO)
            ...
            GtkWidget             *cb  = GTK_WIDGET(gtk_builder_get_object(
               dia.getGtkBuilder(), "checkbutton_remember"));
            assert(cb);
...
void check_and_aquire_lock()
{
   ...
   if (LockedApp > 0) {
      ...
      if (msg != NULL) {
         dia = gtk_message_dialog_new(NULL, GTK_DIALOG_MODAL, GTK_MESSAGE_ERROR,
