...
void RGVendorsEditor::DoAdd(GtkWidget *, gpointer data)
{
	...
	SourcesList::VendorRecord *rec = me->lst.AddVendor(VendorID, FingerPrint, Description);
...
void RGVendorsEditor::DoEdit(GtkWidget *, gpointer data)
{
	...
	SourcesList::VendorRecord &rec = *((SourcesList::VendorRecord *)gtk_clist_get_row_data(GTK_CLIST(me->lstVendors), me->selectedrow));
...
void RGVendorsEditor::DoRemove(GtkWidget *, gpointer data)
{
	...
	SourcesList::VendorRecord *rec = (SourcesList::VendorRecord *)gtk_clist_get_row_data(GTK_CLIST(me->lstVendors), row);
	assert(rec);
	...
	GdkEventButton *event, gpointer data)
{
	...
	const SourcesList::VendorRecord &rec = *((SourcesList::VendorRecord *)gtk_clist_get_row_data(clist, row));
