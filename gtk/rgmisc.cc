...
void RPackageStatus::initColors()
{
	...
	gtk_get_color_from_string(_config->Find(config_string, default_status_colors[i]).c_str(), &StatusColors[i]);
...
void RPackageStatus::init() 
{
	...
	_("Queued for removal with configuration"), 
	_("Not installed but available"), 
	_("Will never be installed"),
	_("Installed"),
